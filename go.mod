module github.com/blue7zz/BTaskAssistant
...
replace reasonix => ./reasonix-app

require reasonix/bridge v0.0.0

replace reasonix/bridge => ./reasonix-bridge
